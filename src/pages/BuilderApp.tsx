...
export default function BuilderApp() {
    ...
    const generateCode = () => {
        let components = elements.map(el => {
                                ...
                                >
                                    ...
                                    {selectedId === el.id && (
                                        <button
                                            ...
                                            className="absolute -right-2 -top-2 w-6 h-6 bg-rose-500 rounded-full flex items-center justify-center border-2 border-black"
                                        >
